...
type DataStruct = Vec<Map>;

fn main() {    
    let (seeds, almanac) = parse_file("./input.data").unwrap();
...
fn parse_file(filepath: &str) -> Result<(Vec<u64>, DataStruct), std::io::Error> {
